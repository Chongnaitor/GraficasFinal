 ...
 * @date 30 Marzo 2020
 * @brief Tiene todas las estructuras y banderas necesarias para el funcionamiento correcto del programa.
 *
 *En este encabezado estableceremos las cosas necesarias como estructuras para que no se tengan que poner manualmente en cada encabezado.
 *
 *
 */
